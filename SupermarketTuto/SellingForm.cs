...
namespace SupermarketTuto
{
    public partial class SellingForm : Form
    {
        ...
        SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\gabri\OneDrive\Documents\smarket.db.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        {
            e.Graphics.DrawString("GABRIEL SUPERMARKET", new Font("Century Gothic", 25, FontStyle.Bold), Brushes.Red, new Point(230));
            ...
            e.Graphics.DrawString("Gabriel", new Font("Century Gothic", 20, FontStyle.Italic), Brushes.Red, new Point(350,230));
        }
        ...
        {
            Con.Open();
            string query = "select ProdName,ProdPrice from ProductTbl where ProdCat='" + SearchCb.SelectedValue + "'";
            SqlDataAdapter sda = new SqlDataAdapter(query, Con);
            SqlCommandBuilder builder = new SqlCommandBuilder(sda);
            var ds = new DataSet();
            sda.Fill(ds);
